    ...
    while (attempts < maxRetries) {
      ...
      try {
        createdLot = await Lot.create({
          ...
          grade: grade || provisionalGrade || 'Grade A',
          provisionalGrade: provisionalGrade || undefined,
          quantityQtl: numQuantity,
          qualityScore: qualityScore !== undefined ? Number(qualityScore) : undefined,
          evidenceConfidence: evidenceConfidence !== undefined ? Number(evidenceConfidence) : undefined,
